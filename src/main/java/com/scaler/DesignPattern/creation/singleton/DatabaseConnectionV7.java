...
public class DatabaseConnectionV7 {
    ...
    public static DatabaseConnectionV7 getInstance() { // fast performance double -checking
        if (dbC == null) {
            ...
            // In java, every class has a lock object associated with it, hence this works.
