...
//        where N represents number of Edges in a Graph and Triplet
//        (B[i][0], B[i][1], B[i][2])
//        implies there is an undirected edge between B[i][0] and B[i][1]
//        and weight of that edge is B[i][2].
//        Find and return the weight of minimum weighted cycle and if
//        there is no cycle return -1 instead.
